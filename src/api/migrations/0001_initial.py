# Generated by Django 3.2.18 on 2023-02-21 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_ipv6', models.CharField(db_column='address_IPv6', max_length=16,blank=True, null=True)),
                ('address_ipv4', models.CharField(db_column='address_IPv4', max_length=16,blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='api.tdevices')),
            ],
            options={
                'db_table': 't_data_set',
